...
const checks: readonly ImportCheck[] = [
  {
    ...
    message:
      'Avoid importing OOXML unit types/constructors from "../../domain/types"; import from "../../../ooxml/domain/units" instead.',
    predicate: (source) =>
  ...
  },
  {
    ...
    message:
      'Avoid importing OOXML Color from "../../domain" or "../../domain/index"; import from "../../../ooxml/domain/color" instead.',
    predicate: (source) =>
  ...
  },
  {
    ...
    message:
      'Avoid importing OOXML Color from "../../domain/color/types"; import from "../../../ooxml/domain/color" instead.',
    predicate: (source) =>
