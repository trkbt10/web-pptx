/**
 * @file DOCX Editor History State
 *
 * Provides undo/redo functionality using the immutable triple-array pattern.
 * Generic implementation allows reuse across different document types.
 */
