...
import type { DocxSectionProperties, DocxHeaderFooterRef } from "@oxen/docx/domain/section";
import type { DocxHeader, DocxFooter, DocxBlockContent } from "@oxen/docx/domain/document";
import type { DocxParagraph } from "@oxen/docx/domain/paragraph";
import type { DocxRelId, HeaderFooterType } from "@oxen/docx/domain/types";
