...
import type { GraphicFrame as GraphicFrameType, Transform } from "@oxen/pptx/domain";
...
import { createResourceStore, type ResourceStore } from "@oxen/pptx/domain/resource-store";
