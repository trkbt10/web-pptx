/**
 * @file Import policy tests for @oxen/pptx-render/react
 *
...
describe("@oxen/pptx-render/react import policy", () => {
  it("does not import OOXML unit types from src/pptx/domain/types", async () => {
    ...
    if (violations.length > 0) {
      throw new Error(
        [
          "Found disallowed imports in packages/@oxen/pptx-render/src/react:",
