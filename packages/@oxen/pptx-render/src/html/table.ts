...
import type { Table, TableCell, TableRow } from "@oxen/pptx/domain/table/types";
import { resolveRowHeight, isFlagEnabled } from "@oxen/pptx/domain/table/resolver";
...
import type { Transform } from "@oxen/pptx/domain/index";
