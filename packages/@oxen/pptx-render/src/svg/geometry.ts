...
import type { ArcToCommand, CubicBezierCommand, CustomGeometry, Geometry, GeometryGuide, GeometryPath, PathCommand, PresetGeometry, QuadBezierCommand, Transform } from "@oxen/pptx/domain";
...
import { resolveFill, formatRgba } from "@oxen/pptx/domain/color/fill";
import type { Fill, Line } from "@oxen/pptx/domain";
import type { ColorContext } from "@oxen/pptx/domain/color/context";
import { createGuideContext, evaluateGuides } from "@oxen/pptx/domain/shape-geometry/guide-engine";
