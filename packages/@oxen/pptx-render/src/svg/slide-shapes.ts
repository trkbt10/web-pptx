...
import type { Shape, SpShape, PicShape, GrpShape, CxnShape, GraphicFrame, Fill, Line, Geometry, OleReference, ChartReference, DiagramReference } from "@oxen/pptx/domain";
 ...
 *
 * @see packages/@oxen/pptx-render/src/react/hooks/useSlideAnimation.ts
 */
