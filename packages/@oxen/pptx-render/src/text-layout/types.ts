...
import type { TextAlign, TextAnchor } from "@oxen/pptx/domain/types";
import type { LineSpacing, TextWrapping, TextOverflow, TextVerticalOverflow, TextVerticalType } from "@oxen/pptx/domain/text";
import type { RenderOptions } from "../render-options";
import type { TextFillConfig } from "@oxen/pptx/domain/drawing-ml/text-fill";
import type { TextEffectsConfig } from "@oxen/pptx/domain/drawing-ml/text-effects";
