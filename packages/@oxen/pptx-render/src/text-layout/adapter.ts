...
import type { TextBody, Paragraph, TextRun, RunProperties, BulletStyle, AutoNumberBullet } from "@oxen/pptx/domain/text";
...
import { resolveThemeFont } from "@oxen/pptx/domain/resolution";
import type { Color } from "@oxen/ooxml/domain/color";
import type { Line, Fill } from "@oxen/pptx/domain/color/types";

import { resolveColor as resolveColorRaw } from "@oxen/pptx/domain/color/resolution";
import { resolveTextFill, resolveTextEffects } from "@oxen/pptx/parser/drawing-ml/index";
import type { ResourceResolver } from "@oxen/pptx/parser/drawing-ml/index";
import { px, pt, pct } from "@oxen/ooxml/domain/units";
import { DEFAULT_FONT_SIZE_PT } from "@oxen/pptx/domain/defaults";
import type { AutoFit } from "@oxen/pptx/domain/text";
