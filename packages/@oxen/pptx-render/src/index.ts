...
export { resolveFill, resolveLine, resolveColorWithAlpha, formatRgba, getDashArrayPattern } from "@oxen/pptx/domain/color/fill";

// =============================================================================
// Types from domain (resource resolver)
// =============================================================================

export type { ResourceResolver } from "@oxen/pptx/domain/resource-resolver";

export { createEmptyResourceResolver } from "@oxen/pptx/domain/resource-resolver";
