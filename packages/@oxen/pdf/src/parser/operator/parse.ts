...
export function createGfxOpsFromStack(stack: GraphicsStateStack): GraphicsStateOps {
  return {
    ...
    setFillCmyk: (args: { readonly c: number; readonly m: number; readonly y: number; readonly k: number }) => stack.setFillCmyk(args),
    setStrokeCmyk: (args: { readonly c: number; readonly m: number; readonly y: number; readonly k: number }) => stack.setStrokeCmyk(args),
