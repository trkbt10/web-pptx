 ...
 * Font-specific metrics are stored in src/metrics/fonts/ directory.
 *
 * To add metrics for a new font:
 * 1. Create a file in src/metrics/fonts/ (e.g., arial.ts)
 * 2. Define and export the FontMetrics object
 * 3. Register in src/metrics/fonts/index.ts
 *
 * @see src/metrics/fonts/ - Font metrics data files
