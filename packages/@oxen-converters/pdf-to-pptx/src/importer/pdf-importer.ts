...
import { openPresentation } from "@oxen-office/pptx/app/open-presentation";
import { parsePdf } from "@oxen/pdf/parser/core/pdf-parser";
import type { PdfPage } from "@oxen/pdf/domain";
import { PdfLoadError } from "@oxen/pdf/parser/core/pdf-load-error";
import {
  buildSlideFromPage,
...
import type { PdfEmbeddedFont } from "@oxen/pdf/domain";
import { generateFontFaceStyle } from "@oxen/pdf/domain/font/font-css-generator";
import type { EmbeddedFontData } from "@oxen-office/pptx/app/presentation-document";
