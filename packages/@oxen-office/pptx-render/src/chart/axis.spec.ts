...
import type { ValueAxis, CategoryAxis } from "@oxen-office/pptx/domain/chart";
import type { TextBody, BodyProperties, ParagraphProperties } from "@oxen-office/pptx/domain/text";
