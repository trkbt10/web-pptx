...
import type { CxnShape, GraphicFrame, GrpShape, PicShape, Shape, SpShape, Transform } from "@oxen-office/pptx/domain/index";
...
import type { ChartReference, DiagramReference, Fill } from "@oxen-office/pptx/domain/index";
