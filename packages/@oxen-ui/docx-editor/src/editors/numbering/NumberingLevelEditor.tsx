...
import type { DocxLevel, DocxLevelJustification } from "@oxen-office/docx/domain/numbering";
import type { NumberFormat, LevelSuffix } from "@oxen-office/ooxml";
import type { DocxIlvl } from "@oxen-office/docx/domain/types";
