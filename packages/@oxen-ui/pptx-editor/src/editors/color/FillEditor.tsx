...
import type { NoFill, SolidFill, GradientFill, PatternFill, PatternType, LinearGradient } from "@oxen-office/ooxml/domain/fill";
import { PATTERN_PRESETS } from "@oxen-office/ooxml/domain/fill";
