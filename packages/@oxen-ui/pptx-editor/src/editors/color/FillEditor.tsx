...
import type { NoFill, SolidFill, GradientFill, PatternFill, PatternType, LinearGradient } from "@oxen-office/drawing-ml/domain/fill";
import { PATTERN_PRESETS } from "@oxen-office/drawing-ml/domain/fill";
import type { Fill, BlipFill } from "@oxen-office/pptx/domain/color/types";
import { deg } from "@oxen-office/drawing-ml/domain/units";
import type { ResourceId } from "@oxen-office/pptx/domain/types";
