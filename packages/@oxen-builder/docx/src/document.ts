...
import type { DocxDocument, DocxBody, DocxBlockContent } from "@oxen-office/docx/domain/document";
import type { DocxParagraph } from "@oxen-office/docx/domain/paragraph";
import type { DocxTable } from "@oxen-office/docx/domain/table";
import { NS_WORDPROCESSINGML, NS_RELATIONSHIPS } from "@oxen-office/docx/constants";
